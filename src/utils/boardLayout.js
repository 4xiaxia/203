...
function planPortraitLayout(topicLayout = {}, topicBottomPct) {
  ...
  return {
    ...
    question: { x: q.x, y: q.y, w: q.w, fontSize: q.fontSize || 30 },
    image: null,
...
function planPortraitWithImageLayout(topicLayout = {}, topicBottomPct) {
  ...
  return {
    ...
    question: {
      ...
      fontSize: topicLayout.question?.fontSize ?? 30,
    },
...
function estimateQuestionBlockHeight(topicLayout = {}) {
  ...
  const fs = Number(topicLayout.question?.fontSize || 30)
  return fs >= 30 ? 16 : 14
}
